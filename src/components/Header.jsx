    ...
    <>
      ...
      <header id="header" className="min-h-screen flex items-center relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-bg-primary dark:via-bg-secondary dark:to-bg-tertiary transition-colors duration-500">
        ...
        <div className="container-wide relative z-40">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 xl:gap-28 items-center pt-20 sm:pt-24 pb-8 sm:pb-12">
            {/* Ultra-Premium Hero Text */}
            <motion.div
              className="max-w-2xl xl:max-w-4xl text-center lg:text-left relative z-30 order-2 lg:order-1"
              initial={{ opacity: 0, x: -50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              <motion.p
                className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold text-primary-700 dark:text-primary-400 mb-6 sm:mb-8 lg:mb-10 uppercase tracking-[0.25em] bg-white bg-opacity-90 dark:bg-white dark:bg-opacity-10 backdrop-blur-3xl px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 rounded-full border border-white border-opacity-60 dark:border-white dark:border-opacity-20 shadow-[0_12px_40px_rgba(99,102,241,0.2)] dark:shadow-none inline-block relative overflow-hidden"
              ...
              <motion.h1
                className="font-heading text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-[0.95] mb-6 sm:mb-8 lg:mb-10 text-balance relative z-50"
              ...
              >
                ...
                <span className="block text-lg sm:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-slate-700 dark:text-gray-200 font-semibold tracking-tight mt-2 sm:mt-3 relative z-50">
                  Mohamed From Sri Lanka
                </span>

                {/* Premium title decoration */}
                <motion.div
                  className="flex items-center justify-center lg:justify-start gap-3 sm:gap-4 mt-4 sm:mt-6"
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={{ opacity: 1, scale: 1 }}
                  transition={{ duration: 0.6, delay: 1.2 }}
                >
                  <div className="h-1 w-12 sm:w-16 bg-gradient-to-r from-primary-500 to-accent-500 rounded-full"></div>
                  <div className="w-2 h-2 sm:w-3 sm:h-3 bg-primary-500 rounded-full animate-pulse"></div>
                  <div className="h-1 w-12 sm:w-16 bg-gradient-to-r from-accent-500 to-primary-500 rounded-full"></div>
                </motion.div>
              </motion.h1>
              ...
              >
                <motion.p
                  className="text-slate-800 dark:text-neutral-200 font-bold text-lg sm:text-xl lg:text-2xl xl:text-3xl block mb-3 sm:mb-4 leading-tight text-pretty"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                <motion.p
                  className="text-slate-600 dark:text-neutral-300 text-sm sm:text-base lg:text-lg xl:text-xl mb-4 sm:mb-6 leading-relaxed text-pretty font-medium"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 1.2 }}
                >
                ...
                <motion.p
                  className="text-sm sm:text-base lg:text-lg xl:text-xl text-slate-500 dark:text-neutral-400 font-semibold leading-relaxed text-pretty"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
              ...
              >
                <a href="#skills" className="btn-primary hover-lift text-sm sm:text-base px-6 sm:px-8 py-3 sm:py-4">
                  <span>View My Work</span>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
                </a>
                <a href="#contact" className="btn-secondary hover-lift text-sm sm:text-base px-6 sm:px-8 py-3 sm:py-4">
            ...
            <motion.div
              className="relative flex items-center justify-center lg:justify-end order-1 lg:order-2 mb-8 lg:mb-0"
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 xl:w-[28rem] xl:h-[28rem] flex items-center justify-center">
                ...
                <div className="absolute z-20 w-32 h-32 sm:w-40 sm:h-40 lg:w-56 lg:h-56 xl:w-64 xl:h-64 rounded-full overflow-hidden border-4 border-white/90 shadow-2xl bg-white/95 dark:bg-slate-200/80 flex items-center justify-center transition-all duration-300 background-wrapper">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  >
                    <div className="w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 xl:w-40 xl:h-40 bg-gradient-to-br from-primary-500 via-primary-600 to-accent-500 rounded-full flex items-center justify-center text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-white shadow-glow-xl border-4 border-white/20 backdrop-blur-sm">
                      <span className="animate-pulse-glow">TM</span>
                    </div>

                    {/* Orbiting elements */}
                    <motion.div
                      className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-4 h-4 sm:w-6 sm:h-6 bg-gradient-to-r from-accent-400 to-accent-500 rounded-full shadow-glow-accent"
                      animate={{ rotate: [0, -360] }}
                      transition={{ duration: 8, repeat: Infinity, ease: "linear" }}
                    />
                    <motion.div
                      className="absolute -bottom-1 -left-1 sm:-bottom-2 sm:-left-2 w-3 h-3 sm:w-4 sm:h-4 bg-gradient-to-r from-primary-400 to-primary-500 rounded-full shadow-glow"
                      animate={{ rotate: [0, -360] }}
                ...
                {/* Decorative elements */}
                <motion.div
                  className="absolute top-2 right-2 sm:top-4 sm:right-4 w-2 h-2 sm:w-3 sm:h-3 bg-accent-400 rounded-full opacity-60"
                  animate={{
                    scale: [1, 1.5, 1],
                    opacity: [0.6, 1, 0.6]
                  }}
                ...
                />
                <motion.div
                  className="absolute bottom-4 left-4 sm:bottom-8 sm:left-8 w-1.5 h-1.5 sm:w-2 sm:h-2 bg-primary-400 rounded-full opacity-70"
                  animate={{
                    scale: [1, 2, 1],
                    opacity: [0.7, 1, 0.7]
                  }}
